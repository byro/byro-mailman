...
urlpatterns = [
    url(r'^members/view/(?P<pk>\d+)/mailman/(?P<list_id>\d+)/remove$', views.MemberAdd.as_view(), name='members.mailman.remove'),
    url(r'^members/view/(?P<pk>\d+)/mailman/add$', views.MemberRemove.as_view(), name='members.mailman.add'),
